...
<html class="no-js" lang="en">
  <head>
    ...
    <?php wp_head(); ?>
    <!-- This tells wp we are coming up on the end of the header and to load anything that may need to go in the head section -->
  </head>

  <body <?php body_class(); ?>>
    <header class="row no-max pad main">
      <!-- Blog info putputs specific info about the wp site based onthe parameters. passing url through will bring up the url of the page -->
